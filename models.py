...
engine = create_engine("postgres://test:test@localhost/mystore?sslmode=disable")
...
if first:
    ...
    session.add_all([
        ...
        Item(id=2, name="Desk", count=10, sold=0, price=89.99),
        Item(id=3, name="Table", count=10, sold=0, price=55.99),
    ])
    session.commit()"""
